...
import type { SongPackListItem } from "@/entities/virtual-crew"
...
describe("SongPacksList", () => {
  ...
  it("row click → /virtual-crew/song-packs/:id 라우팅", () => {
    render(
      <MemoryRouter initialEntries={["/virtual-crew/song-packs"]}>
        <Routes>
          <Route
            path="/virtual-crew/song-packs"
            element={
              <SongPacksList
                rows={rows}
                isLoading={false}
          ...
          />
          <Route
            path="/virtual-crew/song-packs/:id"
