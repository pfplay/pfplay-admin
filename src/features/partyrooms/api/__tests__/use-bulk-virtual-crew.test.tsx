...
import type { VirtualCrewBulkRequest } from "@/features/partyrooms/model/virtual-crew-bulk-schema"
...
describe("useBulkVirtualCrew", () => {
  ...
  it("on success: invalidates ['partyrooms'], toast.success with count", async () => {
    ...
    server.use(
      http.put("*/api/v1/admin/virtual-crew/bulk", () => new HttpResponse(null, { status: 204 })),
    )

    const { result } = renderHook(() => useBulkVirtualCrew(), { wrapper })
